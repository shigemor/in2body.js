...
(function( root, factory){
		...
		in2body.prototype= {
			...
			get: function( arg){
				...
				switch( arg){
					...
					case 'pageYRatio':
						result= result_YRatio;
						break;
						
					case 'pageXRatio':
						result= result_XRatio;
						break;
					...
					case 'pageYRatio_finely':
						var max_Y= Math.max( document.body.scrollHeight, document.documentElement.scrollHeight,
											 document.body.offsetHeight, document.documentElement.offsetHeight,
											 document.body.clientHeight, document.documentElement.clientHeight);
						result= Math.floor( Math.ceil( window.pageYOffset+ document.documentElement.clientHeight)/ max_Y* 100);
						break;
					...
					case 'pageXRatio_finely':
						var max_X= Math.max( document.body.scrollWidth, document.documentElement.scrollWidth,
											 document.body.offsetWidth, document.documentElement.offsetWidth,
											 document.body.clientWidth, document.documentElement.clientWidth);
						result= Math.floor( Math.ceil( window.pageXOffset+ document.documentElement.clientWidth)/ max_X* 100);
						break;
						
					case 'version':
						result= '1.0.0'; // ver1.0.0
						break;
				}
				return result;
			},
		...
		function Update_in2body(){
			...
			var max_Y= Math.max( document.body.scrollHeight, document.documentElement.scrollHeight,
								 document.body.offsetHeight, document.documentElement.offsetHeight,
								 document.body.clientHeight, document.documentElement.clientHeight);
			result_YRatio= Math.floor( Math.ceil( window.pageYOffset+ document.documentElement.clientHeight)/ max_Y* 10)* 10 *( (window.pageYOffset < 1)? 0 : 1 );
			
			var max_X= Math.max( document.body.scrollWidth, document.documentElement.scrollWidth,
								 document.body.offsetWidth, document.documentElement.offsetWidth,
								 document.body.clientWidth, document.documentElement.clientWidth);
			result_XRatio= Math.floor( Math.ceil( window.pageXOffset+ document.documentElement.clientWidth)/ max_X* 10)* 10 *( (window.pageXOffset < 1)? 0 : 1 );
